...
with (obj_uiButton)
{
    if (argument0 == id)
    {
        ...
        {
            obj_dyaFighterSelect.startgame = 1;
        }
        else if (bID == 4)
        {
            if (type == 2)
        ...
        else if(bID == 18)
        {
            with(obj_uiField)
                if(fID == 1)
                    obj_dyaFighterSelect.search = content;
            search_ui(obj_dyaFighterSelect.search);
            with(zui_get_parent())
                zui_destroy();
        }
    }
...
with (obj_uiLabel)
{
    if (argument0 == id)
    {
        ...
        else if(lID == 1)
        {
            ...
            obj_dyaFighterSelect.search = keyboard_string;
            caption = "Type Search Term:##" + obj_dyaFighterSelect.search;
        }
    }
}
