...
var a = scr_sample(argument0 - hs, argument1 - hs);
var b = scr_sample(argument0 + hs, argument1 - hs);
var c = scr_sample(argument0 - hs, argument1 + hs);
var d = scr_sample(argument0 + hs, argument1 + hs);
